...
// Token0: BUSD
const _outputToLp0Route: string[] = [TOKENS.ASHARE.BSC,TOKENS.BUSD.BSC] ;
...
export const STRAT_AHARE_BUSD_BSC = {
  nameToken0,
  nameToken1,
  constructorArgs,
};
